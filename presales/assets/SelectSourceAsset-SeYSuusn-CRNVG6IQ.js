...
`;const G=({opts:i,isLoading:a,onSelectSource:n})=>e.jsx(j,{showClose:!1,showBack:!0,onBack:()=>n(i.source.selectedAsset),title:"Select currency",children:e.jsx(L,{children:i.source.assets.map((s=>{let{icon:c,name:u}=p[s];return e.jsx(D,{onClick:()=>n(s),disabled:a,children:e.jsxs(B,{children:[e.jsx(K,{children:c}),e.jsxs(M,{children:[e.jsx(R,{children:u}),e.jsx(U,{children:s.toLocaleUpperCase()})]})]})},s)}))})});let L=o.div`
  display: flex;
