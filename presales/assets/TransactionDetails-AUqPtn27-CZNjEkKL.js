import{fL as e,ay as p,fZ as P,h3 as d,fa as l}from"./index-BO8doAA9.js";import{p as S,S as u,h as g}from"./WalletLink-Zbko38hC-B-LEhSXu.js";import{c as v}from"./ethers-DlHjdxyJ-MATA8OEv.js";import{d as f}from"./Layouts-BlFm53ED-BbovkXPK.js";import{F as I}from"./ChevronDownIcon-CUqxTczp.js";const h=({label:t,children:n,valueStyles:i})=>e.jsxs(C,{children:[e.jsx("div",{children:t}),e.jsx(B,{style:{...i},children:n})]});let C=l.div`
  display: flex;
  align-items: center;
...
`;const U=({from:t,to:n,txn:i,transactionInfo:r,tokenPrice:o,gas:c,tokenSymbol:x})=>{let w=BigInt((i==null?void 0:i.value)||0);return e.jsx(T,{...P().render.standalone?{defaultValue:"details"}:{},children:e.jsxs($,{value:"details",children:[e.jsx(z,{children:e.jsxs(q,{children:[e.jsx("div",{children:(r==null?void 0:r.title)||"Details"}),e.jsx(G,{children:e.jsx(S,{weiQuantities:[w],tokenPrice:o,tokenSymbol:x})})]})}),e.jsxs(E,{children:[e.jsx(h,{label:"From",children:e.jsx(u,{walletAddress:t,chainId:i.chainId||p,chainType:"ethereum"})}),e.jsx(h,{label:"To",children:e.jsx(u,{walletAddress:n,chainId:i.chainId||p,chainType:"ethereum"})}),r&&r.action&&e.jsx(h,{label:"Action",children:r.action}),c&&e.jsx(A,{value:i.value,gas:c,tokenPrice:o,tokenSymbol:x})]}),e.jsx(Q,{children:({isActive:k})=>e.jsx(F,{value:i.value,displayFee:k,gas:c||"0x0",tokenPrice:o,tokenSymbol:x})})]})})};let q=l.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`,G=l.div`
